...
LightDependentResistor::LightDependentResistor(int pin, unsigned int adc_resolution_bits, unsigned long other_resistor, ePhotoCellKind kind) :
...
LightDependentResistor::LightDependentResistor(int pin, unsigned int adc_resolution_bits, unsigned long other_resistor, float mult_value, float pow_value) :
  _photocell_on_ground (true),
  _pin (pin),
  _other_resistor (other_resistor),
